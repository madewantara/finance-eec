...
class FilterIndexOperational extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.executive-director.filter-index-operational', ['transaction' => $transaction, 'account' => $account, 'pic' => $pic, 'paidto' => $paidto, 'project' => $project, 'distAllTrans' => $distAllTrans, 'operationalBalance' => $operationalBalance]);
    }
}
