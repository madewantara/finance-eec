...
class FilterIndexCash extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.executive-director.filter-index-cash', ['transaction' => $transaction, 'account' => $account, 'pic' => $pic, 'paidto' => $paidto, 'project' => $project, 'distAllTrans' => $distAllTrans, 'cashBalance' => $cashBalance]);
    }
}
