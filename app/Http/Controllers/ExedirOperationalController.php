...
use App\Exports\ExecutiveDirector\OperationalExport;
...
class ExedirOperationalController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('executive-director.operational.index', compact('picex', 'projectex', 'accountex', 'paidtoex'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('executive-director.operational.show', compact('transaction', 'report', 'attach', 'activity'));
    }
    ...
    */
    public function export(Request $request) 
    {
        ...
        if($request->format == 'pdf'){
            ...
            $pdf = PDF::loadView('executive-director.operational.pdf', ['dataTrans' => $dataTrans, 'todayDate' => $todayDate]);
    ...
    */
    public function exportDetail($uuid) 
    {
        ...
        $pdf = PDF::loadView('executive-director.operational.pdfDetail', ['transactionDebit' => $transactionDebit, 'sum' => $sum, 'inWords' => $inWords, 'todayDate' => $todayDate, 'signatureFindivStore' => $signatureFindivStore, 'signatureFindivPaid' => $signatureFindivPaid, 'signatureFindir' => $signatureFindir, 'signatureExedir' => $signatureExedir]);
        $pdf->setPaper('A4', 'landscape');
