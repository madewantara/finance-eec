...
use App\Exports\FinanceDirector\AccountExport;
use Maatwebsite\Excel\Facades\Excel;
use Carbon\Carbon;
use Barryvdh\DomPDF\Facade\Pdf;

class FindirAccountController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('finance-director.account.index', compact('allCategory', 'account', 'categories', 'countCategory'));
    }
    ...
    */
    public function export(Request $request) 
    {
        ...
        if($request->format == 'pdf'){
            ...
            $pdf = PDF::loadView('finance-director.account.pdf', ['arrayData' => $arrayData, 'todayDate' => $todayDate]);
