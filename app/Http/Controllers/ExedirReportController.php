...
class ExedirReportController extends Controller
{
    ...
    {
        return view('executive-director.report.index');
    }
    ...
    public function show($uuid)
    {
        ...
        if($report->report_type == 1){
            ...
            return view('executive-director.report.show', [
                'kas' => $kas,
                'bank' => $bank,
                'stock' => $stockd - $stockc,
                'biayamuka' => $biayamuka,
    ...
    public function export(Request $request){
        ...
        if($validated['export_format'] == 'pdf'){
            if($report->report_type == 1){
                ...
                $pdf = PDF::loadView('executive-director.report.balancesheetPdf', [
                    'kas' => $kas,
                    'bank' => $bank,
                    'stock' => $stockd - $stockc,
                    'biayamuka' => $biayamuka,
                ...
                $pdf = PDF::loadView('executive-director.report.profitledgerPdf', [
                    'year' => $year,
                    'pendapatan' => $nett,
                    'biayalangsung' => $output,
                    'gross' => $margin,
