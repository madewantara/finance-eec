...
use App\Exports\FinanceDirector\CashExport;
...
class FindirCashController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('finance-director.cash.index', compact('picex', 'projectex', 'accountex', 'paidtoex'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('finance-director.cash.show', compact('transaction', 'report', 'attach', 'activity'));
    }
    ...
    */
    public function export(Request $request) 
    {
        ...
        if($request->format == 'pdf'){
            ...
            $pdf = PDF::loadView('finance-director.cash.pdf', ['dataTrans' => $dataTrans, 'todayDate' => $todayDate]);
    ...
    */
    public function exportDetail($uuid) 
    {
        ...
        $pdf = PDF::loadView('finance-director.cash.pdfDetail', ['transactionDebit' => $transactionDebit, 'sum' => $sum, 'inWords' => $inWords, 'todayDate' => $todayDate, 'signatureFindivStore' => $signatureFindivStore, 'signatureFindivPaid' => $signatureFindivPaid, 'signatureFindir' => $signatureFindir, 'signatureExedir' => $signatureExedir]);
        $pdf->setPaper('A4', 'landscape');
