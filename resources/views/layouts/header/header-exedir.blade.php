...
<div id="kt_header" class="header align-items-stretch bg-white">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('exedir.dashboard') }}" class="d-lg-none">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                        ...
                        <div class="menu-item menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" href="{{ route('exedir.dashboard') }}">
                                <span
                                    class="menu-title @if (Route::currentRouteName() == 'exedir.dashboard') text-primary fw-bolder @endif">Dashboard</span>
                            </a>
                        </div>
                        <div class="menu-item menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" href="{{ route('exedir.account-index') }}">
                                <span
                                    class="menu-title @if (Route::currentRouteName() == 'exedir.account-index') text-primary fw-bolder @endif">Accounts</span>
                            </a>
                        </div>
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <span class="menu-link py-3">
                                <span
                                    class="menu-title @if (Route::currentRouteName() == 'exedir.cash-index' || Route::currentRouteName() == 'exedir.cash-detail' || Route::currentRouteName() == 'exedir.operational-index' || Route::currentRouteName() == 'exedir.operational-detail' || Route::currentRouteName() == 'exedir.escrow-index' || Route::currentRouteName() == 'exedir.escrow-detail') text-primary fw-bolder @endif">Journals</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </span>
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ route('exedir.cash-index') }}"
                                        ...
                                        <span
                                            class="menu-title @if (Route::currentRouteName() == 'exedir.cash-index' || Route::currentRouteName() == 'exedir.cash-detail') text-primary @endif">Cash
                                            Journal</span>
                                    </a>
                                    <a class="menu-link py-3" href="{{ route('exedir.operational-index') }}"
                                        ...
                                        <span
                                            class="menu-title @if (Route::currentRouteName() == 'exedir.operational-index' || Route::currentRouteName() == 'exedir.operational-detail') text-primary @endif ">Mandiri
                                            Operational Journal</span>
                                    </a>
                                    <a class="menu-link py-3" href="{{ route('exedir.escrow-index') }}"
                                        ...
                                        <span
                                            class="menu-title @if (Route::currentRouteName() == 'exedir.escrow-index' || Route::currentRouteName() == 'exedir.escrow-detail') text-primary @endif">Mandiri
                                            Escrow Journal</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="menu-item menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" href="{{ route('exedir.project-index') }}">
                                <span
                                    class="menu-title @if (Route::currentRouteName() == 'exedir.project-index' || Route::currentRouteName() == 'exedir.project-detail') text-primary fw-bolder @endif">Projects</span>
                            </a>
                        </div>
                        <div class="menu-item menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" href="{{ route('exedir.report-index') }}">
                                <span
                                    class="menu-title @if (Route::currentRouteName() == 'exedir.report-index' || Route::currentRouteName() == 'exedir.report-detail') text-primary fw-bolder @endif">Reports</span>
                            </a>
                        </div>
                    </div>
                    <!--end::Menu-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                            ...
                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                ...
                                <div class="text-white px-9 mb-6 mt-1 fs-8 opacity-75 fst-italic">For the last 7
                                    days
                                </div>
                                <!--end::Title-->
                                                            ...
                                                            <div class="col-lg-9">
                                                                @if ($nt['category'] == 'cash')
                                                                    @if ($nt['status'] == 2)
                                                                        ...
                                                                        <span class="text-gray-800">
                                                                            This
                                                                            <a href="{{ route('exedir.cash-detail', ['uuid' => $nt['uuid']]) }}"
                                                                ...
                                                                @elseif ($nt['category'] == 'operational')
                                                                    @if ($nt['status'] == 2)
                                                                        ...
                                                                        <span class="text-gray-800">
                                                                            This
                                                                            <a href="{{ route('exedir.operational-detail', ['uuid' => $nt['uuid']]) }}"
                                                                                class="text-hover-primary"
                                                                                style="color: #009ef7e0">
                                                                                #{{ $nt['token'] }}</a>
                                                                ...
                                                                @else
                                                                    @if ($nt['status'] == 2)
                                                                        ...
                                                                        <span class="text-gray-800">
                                                                            This
                                                                            <a href="{{ route('exedir.escrow-detail', ['uuid' => $nt['uuid']]) }}"
                                                                                class="text-hover-primary"
                                                                                style="color: #009ef7e0">
                                                                                #{{ $nt['token'] }}</a>
                                                        ...
                                                        <div class="row align-items-center me-2">
                                                            ...
                                                            <div class="col-lg-9">
                                                                @if ($nr['report'] == 1)
                                                                    ...
                                                                    <span class="text-gray-800 ">
                                                                        This
                                                                        <a href="{{ route('exedir.report-detail', ['uuid' => $nr['uuid']]) }}"
                                                                            class="text-hover-primary"
                                                                            style="color: #009ef7e0">
                                                                            balance sheet</a>
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">Max Smith
                                            <span
                                                class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Executive
                                                Director</span>
                                        </div>
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('exedir.profile') }}" class="menu-link px-5">My Profile</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('exedir.dashboard') }}"
                            class="text-muted text-hover-primary">Dashboard</a>
                    </li>
                    <!--end::Item-->
                    @if (Route::currentRouteName() != 'exedir.dashboard')
                        <!--begin::Item-->
