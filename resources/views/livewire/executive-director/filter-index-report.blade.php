                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @else
                                @foreach ($report as $index => $r)
                                        ...
                                        <td class="text-end pe-0">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('exedir.report-detail', ['uuid' => $r->uuid]) }}"
                                                        class="menu-link px-3">View</a>
                                                </div>
                                                <div class="separator border-gray-200"></div>
                                                <div class="menu-item px-3">
                                                    <button type="button" wire:click="edit('{{ $r->uuid }}')"
                                                        class="btn btn-light-primary menu-link w-100 py-2 mt-3 justify-content-center text-primary text-hover-white fs-7"
                                                        style="font-weight: 500;"
                                                        @if ($r->status == 2 || $r->status == 3) disabled @endif>Approval</button>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#exportReport{{ $index }}"
                                                        class="btn btn-light-success menu-link w-100 py-2 mt-3 justify-content-center text-success text-hover-white fs-7"
                                    ...
                                    <!--Modal Approval-->
                                    <div wire:ignore.self class="modal fade" id="approvalRep" tabindex="-1"
                                        aria-labelledby="approvalRep" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form wire:submit.prevent="approveRep" id="approveRep"
                                                        autocomplete="off">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" form="approveRep">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form" id="export{{ $index }}"
                                                        action="{{ route('exedir.report-export', ['uuid' => $r->uuid]) }}"
...
@push('js')
    ...
    <script>
        window.livewire.on('openEditRep', function() {
            $('#approvalRep').modal('show');
        })
    </script>
    <script>
        window.livewire.on('closeApproval', function() {
            $('#approvalRep').modal('hide');
        })
    </script>
@endpush
