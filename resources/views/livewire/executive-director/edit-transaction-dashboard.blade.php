<div>
    ...
    <div class="row gy-5 g-xl-8">
        <div class="col-xl-6">
            ...
            <a href="{{ route('exedir.cash-index') }}" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <!--begin::Statistics Widget 5-->
            <a href="{{ route('exedir.operational-index') }}"
                                    ...
                                    @foreach ($needApprovedCash as $npc)
                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <a href="{{ route('exedir.cash-detail', ['uuid' => $npc->uuid]) }}"
                                    ...
                                    @foreach ($needApprovedOpt as $npo)
                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <a href="{{ route('exedir.operational-detail', ['uuid' => $npo->uuid]) }}"
    ...
    <div class="row gy-5 g-xl-8">
        <div class="col-xl-6">
            <!--begin::Statistics Widget 5-->
            <a href="{{ route('exedir.escrow-index') }}"
        ...
        <div class="col-xl-6">
            <!--begin::Statistics Widget 5-->
            <a href="{{ route('exedir.report-index') }}" class="card hoverable card-xl-stretch mb-xl-8"
                style="background-color: #e16d42;">
                <!--begin::Body-->
                <div class="card-body">
                    <!--begin::Svg Icon | path: icons/duotone/Home/Building.svg-->
                    <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                        <i class="bi bi-book-half" style="font-size: 3rem; color:#fff;"></i>
                    </span>
                    <!--end::Svg Icon-->
    ...
    <div class="row gy-5 g-xl-8">
                                    ...
                                    @foreach ($needApprovedEsc as $npe)
                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <a href="{{ route('exedir.escrow-detail', ['uuid' => $npe->uuid]) }}"
        ...
        <div class="col-xl-6">
            ...
            <div class="card card-xl-stretch mb-xl-8">
                ...
                <div class="card-header border-0 pt-5 pb-2">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-4 mb-1">Report Overview</span>
                        <span class="text-muted fw-bold fs-7">Report statistics</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                        ...
                        <div class="card-p pt-3 bg-body flex-grow-1">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col mr-8">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="fs-4 fw-bolder">{{ count($repPen) }}
                                    </div>
                                    <!--end::Stat-->
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="fs-4 fw-bolder ">{{ count($repAcc) }}</div>
                                    <!--end::Stat-->
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row g-0 mt-8">
                                ...
                                <div class="col mr-8">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="fs-4 fw-bolder">{{ count($repRej) }}</div>
                                    <!--end::Stat-->
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="mt-10">
                                <h3 class="card-title align-items-start d-flex flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Action Needed</span>
                                    <span class="text-muted fw-bold fs-7">Report that need to be approved or
                                        rejected</span>
                                </h3>
                            </div>
                            <!--begin::Items-->
                            <div class="mt-5">
                                @if (count($needApprovedRep) == 0)
                                    <div class="container d-flex align-items-center justify-content-center h-125px">
                                        <div class="text-muted fw-bolder fst-italic mt-5 text-center">
                                            There are no reports to approve or reject
                                        </div>
                                    </div>
                                @else
                                    @foreach ($needApprovedRep as $npr)
                                        <!--begin::Item-->
                                        <div class="d-flex flex-stack mb-5">
                                            <!--begin::Section-->
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    @if ($npr->report_type == 1)
                                                        <a href="{{ route('exedir.report-detail', ['uuid' => $npr->uuid]) }}"
                                                            class="fs-6 text-gray-800 text-hover-primary fw-bolder">Balance
                                                            Sheet</a>
                                                    @else
                                                        <a href="{{ route('exedir.report-detail', ['uuid' => $npr->uuid]) }}"
                                                            class="fs-6 text-gray-800 text-hover-primary fw-bolder">Profit
                                                            Ledger</a>
                                                    @endif
                                                    <div class="fs-7 text-muted fw-bold mt-1">{{ $npr->year }}
                                                    </div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Label-->
                                            <button type="button" wire:click="editReport('{{ $npr->uuid }}')"
                                                class="btn btn-light-primary menu-link w-10 py-2 justify-content-center text-primary text-hover-white fs-8"
                                                style="font-weight: 500;">Approval</button>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    @endforeach
                                    <div wire:ignore.self class="modal fade" id="approvalReport" tabindex="-1"
                                        aria-labelledby="approvalReport" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
...
@push('js')
    ...
    <script>
        window.livewire.on('openEditReport', function() {
            $('#approvalReport').modal('show');
        })
    </script>
    <script>
        window.livewire.on('closeReportApproval', function() {
            $('#approvalReport').remove();
            $('.modal-backdrop').remove();
            $('body').removeClass("modal-open");
            $('body').css({
                "overflow-y": "scroll"
