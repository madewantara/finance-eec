                        ...
                        <tbody class="fs-7 text-gray-600 fw-bold">
                            @foreach ($transaction as $trans)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        @if ($trans[0]->category == 'cash')
                                            <a href="{{ route('findir.cash-detail', ['uuid' => $trans[0]->uuid]) }}"
                                                class="btn btn-light btn-active-light-primary btn-sm"
                                                style="padding: 5px 10px;">
                                                View
                                            </a>
                                        @elseif ($trans[0]->category == 'operational')
                                            <a href="{{ route('findir.operational-detail', ['uuid' => $trans[0]->uuid]) }}"
                                                class="btn btn-light btn-active-light-primary btn-sm"
                                                style="padding: 5px 10px;">
                                                View
                                            </a>
                                        @else
                                            <a href="{{ route('findir.escrow-detail', ['uuid' => $trans[0]->uuid]) }}"
                                                class="btn btn-light btn-active-light-primary btn-sm"
                                                style="padding: 5px 10px;">
                                                View
                                            </a>
