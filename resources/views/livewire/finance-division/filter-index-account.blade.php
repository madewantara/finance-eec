    ...
    <div class="card-body pt-0 table-responsive">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
            ...
            <tbody class="text-gray-600 fw-bold">
                @if (count($account) == 0)
                    <tr>
                        <td colspan="4" class="text-muted fst-italic mt-5 text-center">There are no financial accounts
                        </td>
                    </tr>
                @else
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <button class="btn-delete menu-link px-3 fw-bold"
                                            wire:click="confirmDelete('{{ $acc->uuid }}')">Delete</button>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function(event) {
            @this.on('triggerDelete', uuid => {
                Swal.fire({
                    title: "Are you sure?",
                    text: "If you delete this account, it will be permanently deleted.",
                    icon: "warning",
