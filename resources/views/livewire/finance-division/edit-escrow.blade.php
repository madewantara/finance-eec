<div>
    ...
    <!--begin::Form-->
    <form action="{{ route('findiv.escrow-update', ['uuid' => $uuid]) }}" novalidate method="post"
            ...
            <div class="d-flex flex-column flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4 text-center align-items-center"
                ...
                <div wire:ignore>
                    <input type="text"
                        ...
                        placeholder="AB/000/ABCD/I/0000" name="token" wire:model.defer="token" style="color: #5e6278;"
                        required />
                    <input type="hidden"
            ...
            <div class="d-flex align-items-baseline justify-content-end flex-equal order-3 fw-row"
                ...
                <div class="position-relative d-flex flex-column align-items-center w-150px">
                    ...
                    <select
                        ...
                        name="type" wire:model.defer="type" required>
                        <option></option>
                        @if ($this->type == 1)
        ...
        <div class="mb-0">
            ...
            <div class="row gx-10 mb-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5">
                        <input type="text" name="pic" wire:model.defer="pic"
