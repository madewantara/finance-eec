            ...
            <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                ...
                <div class="d-flex flex-column align-items-start justift-content-center flex-equal me-5">
                    ...
                    <h1 class="text-gray-800 mb-5 mb-lg-10" style="font-size: 450%; font-weight: 400;">
                        Rp. {{ number_format($escrowBalance[0]->balance, 0, ',', '.') }}
                    </h1>
                ...
                <div class="flex-row-fluid justify-content-end gap-5" data-kt-subscription-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-500px w-md-525px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5" data-kt-subscription-table-filter="form">
                            <form wire:submit.prevent="submitfilterescrow" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <!--begin::Input group-->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                ...
                                                wire:click="resetescrow()">Reset</button>
                    ...
                    <a href="{{ route('findiv.escrow-create') }}" class="btn btn-primary">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                ...
                <tbody class="text-gray-600 fw-bold">
                    @if (count($transaction) == 0)
                        <tr>
                            <td colspan="12" class="text-muted fst-italic mt-5 text-center">There are no mandiri escrow
                                transactions
                            </td>
                        </tr>
                    @else
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('findiv.escrow-detail', ['uuid' => $trans[0][0]->uuid]) }}"
                                                class="menu-link px-3">View</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ route('findiv.escrow-edit', ['uuid' => $trans[0][0]->uuid]) }}"
