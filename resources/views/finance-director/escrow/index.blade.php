...
@section('title', 'Mandiri Escrow Journal | Finance Director')

@section('page-title') <a href="{{ route('findir.escrow-index') }}" class="text-dark text-hover-primary">Mandiri
        Escrow Journal</a>
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            <!--begin::Card-->
            @livewire('finance-director.filter-index-escrow')
            <!--end::Card-->
            <!--begin::Modals-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form action="{{ route('findir.escrow-export') }}" method="POST" id="export"
                                autocomplete="off">
                                @csrf
                                <!--begin::Input group-->
