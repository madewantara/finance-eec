...
@section('title', 'Detail Mandiri Escrow Transaction | Finance Director')
                            ...
                            <div class="mx-auto w-100">
                                                            ...
                                                            @foreach ($attach as $index => $atc)
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="reportModal{{ $index }}" tabindex="-1"
                                                                        aria-hidden="true">
                                ...
                                <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                                    ...
                                    <div class="my-1 me-5">
                                        <!-- begin::Print-->
                                        <form method="post"
                                            action="{{ route('findir.escrow-detail-export', ['uuid' => $transaction[0]->uuid]) }}">
                                            @csrf
                                                    ...
                                                    <div>
                                                        ...
                                                        @elseif ($a['log']->category == 'escrow-approved-excdir')
                                                            <span>Has <b><i class="text-dark fw-bolder">approved</i></b>
                                                                this transaction on
                                                                {{ $a['log']->updated_at->format('l, jS \of F Y h:i:s A') }}</span>
                                                        @elseif ($a['log']->category == 'escrow-rejected')
...
@push('js')
    <script src="{{ asset('assets/js/finance-director/create.js') }}"></script>
@endpush
