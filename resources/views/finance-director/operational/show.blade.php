...
@section('title', 'Detail Mandiri Operational Transaction | Finance Director')

@section('page-title') <a href="{{ route('findir.operational-index') }}" class="text-dark text-hover-primary">Mandiri
                            ...
                            <div class="mx-auto w-100">
                                ...
                                <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                                    ...
                                    <div class="my-1 me-5">
                                        <!-- begin::Print-->
                                        <form method="post"
                                            action="{{ route('findir.operational-detail-export', ['uuid' => $transaction[0]->uuid]) }}">
                                            @csrf
