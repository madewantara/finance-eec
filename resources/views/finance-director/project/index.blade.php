...
@section('title', 'Project | Finance Director')

@section('page-title') <a href="{{ route('findir.project-index') }}" class="text-dark text-hover-primary">Project</a>
@endsection
...
@push('css')
    <link href="{{ asset('assets/css/finance-director/datatables.bundle.css') }}" rel="stylesheet" type="text/css">
@endpush
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_content_container" class="container-xxl">
                                ...
                                @foreach ($projectActiveLim as $index => $pal)
                                    <div class="fs-6 d-flex justify-content-between mb-4">
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="{{ route('findir.project-detail', ['uuid' => $pal->uuid]) }}"
            ...
            <!--end::Stats-->
            @livewire('finance-director.filter-index-project', ['arrhighProjectExpanse' => $arrhighProjectExpanse])
            <!--begin::Modals-->
