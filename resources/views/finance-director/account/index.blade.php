...
@section('title', 'Account | Finance Director')

@section('page-title') <a href="{{ route('findir.account-index') }}" class="text-dark text-hover-primary">Account</a>
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            ...
            <!--begin::Card-->
            <div class="card">
                @livewire('finance-director.filter-index-account')
            </div>
            <!--end::Card-->
            <!--begin::Modals-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form id="kt_subscriptions_export_form" action="{{ route('findir.account-export') }}"
