...
@section('title', 'Mandiri Escrow Journal | Executive Director')

@section('page-title') <a href="{{ route('exedir.escrow-index') }}" class="text-dark text-hover-primary">Mandiri
        Escrow Journal</a>
@endsection

@section('sub-page-title', 'Mandiri Escrow Transaction List')
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            <!--begin::Card-->
            @livewire('executive-director.filter-index-escrow')
            <!--end::Card-->
            <!--begin::Modals-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Export Mandiri Escrow Transaction <br> <span
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form action="{{ route('exedir.escrow-export') }}" method="POST" id="export"
                                autocomplete="off">
                                @csrf
                                <!--begin::Input group-->
...
@push('js')
    <script src="{{ asset('assets/js/executive-director/export.js') }}"></script>
