...
@section('title', 'Account | Executive Director')

@section('page-title') <a href="{{ route('exedir.account-index') }}" class="text-dark text-hover-primary">Account</a>
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            ...
            <!--begin::Card-->
            <div class="card">
                @livewire('executive-director.filter-index-account')
            </div>
            <!--end::Card-->
            <!--begin::Modals-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form id="kt_subscriptions_export_form" action="{{ route('exedir.account-export') }}"
