...
@section('title', 'Project | Executive Director')

@section('page-title') <a href="{{ route('exedir.project-index') }}" class="text-dark text-hover-primary">Project</a>
@endsection
...
@push('css')
    <link href="{{ asset('assets/css/executive-director/datatables.bundle.css') }}" rel="stylesheet" type="text/css">
@endpush
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="fs-4 fw-bold text-gray-400 mb-7">Total Projects</div>
                            <!--end::Heading-->
                            <!--begin::Wrapper-->
                            @if (count($project) == 0)
                                ...
                                @foreach ($projectActiveLim as $index => $pal)
                                    <div class="fs-6 d-flex justify-content-between mb-4">
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="{{ route('exedir.project-detail', ['uuid' => $pal->uuid]) }}"
            ...
            <!--end::Stats-->
            @livewire('executive-director.filter-index-project', ['arrhighProjectExpanse' => $arrhighProjectExpanse])
            <!--begin::Modals-->
