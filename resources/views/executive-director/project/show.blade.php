...
@section('title')
    {{ $project[0]->name . ' | Executive Director' }}
@endsection

@section('page-title')
    <a href="{{ route('exedir.project-index') }}" class="text-dark text-hover-primary">Project</a>
@endsection
...
@push('css')
    <link href="{{ asset('asset/css/executive-director/datatables.bundle.css') }}" rel="stylesheet" type="text/css">
@endpush
        ...
        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        <a href="{{ route('exedir.project-detail', ['uuid' => $uuid]) }}"
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" role="tabpanel" id="budget">
                    @livewire('executive-director.filter-project-budget', ['uuid' => $uuid]);
                </div>
                {{-- end::budget --}}
                {{-- begin::files --}}
                                                            ...
                                                            <div class="overflow-auto pe-3">
                                                                @if ($lpa[1] == 'cash-store')
                                                                    ...
                                                                    <div class="fs-5 fw-bold mb-2">Has <i
                                                                            class="text-dark fw-bolder">created</i>
                                                                        <a href="{{ route('exedir.cash-detail', ['uuid' => $lpa[4]]) }}"
                                                                ...
                                                                @elseif ($lpa[1] == 'operational-store')
                                                                    ...
                                                                    <div class="fs-5 fw-bold mb-2">Has <i
                                                                            class="text-dark fw-bolder">created</i>
                                                                        <a href="{{ route('exedir.operational-detail', ['uuid' => $lpa[4]]) }}"
                                                                            class="text-hover-primary"
                                                                            style="color: #009ef7e0">#{{ $lpa[3] }}</a>
                                                                ...
                                                                @elseif ($lpa[1] == 'escrow-store')
                                                                    ...
                                                                    <div class="fs-5 fw-bold mb-2">Has <i
                                                                            class="text-dark fw-bolder">created</i>
                                                                        <a href="{{ route('exedir.escrow-detail', ['uuid' => $lpa[4]]) }}"
                                                                            class="text-hover-primary"
                                                                            style="color: #009ef7e0">#{{ $lpa[3] }}</a>
...
@push('js')
    <script src="{{ asset('assets/js/executive-director/datatables.bundle.js') }}"></script>
    <script src="{{ asset('assets/js/executive-director/list.js') }}"></script>
@endpush
