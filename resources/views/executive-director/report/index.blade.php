...
@section('title', 'Report | Executive Director')

@section('page-title') <a href="{{ route('exedir.report-index') }}" class="text-dark text-hover-primary">Report</a>
@endsection

@section('sub-page-title', 'Report Download Center')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10"
                style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('/assets/image/random/report.png')">
                <!--begin::Card header-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-muted fw-bolder">
                                <span>Generate <b><i>balance sheet</i></b> or <b><i>profit
                                            ledger</i></b> report with specific
                                    year</span>
                            </div>
                        </div>
                        <!--end::Title-->
            ...
            <!--end::Card-->
            <!--begin::Report-->
            @livewire('executive-director.filter-index-report')
            <!--end::Report-->
        </div>
        <!--end::Container-->
    </div>
