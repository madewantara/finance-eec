...
@section('title', 'Mandiri Operational Journal | Executive Director')
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            <!--begin::Card-->
            @livewire('executive-director.filter-index-operational')
            <!--end::Card-->
            <!--begin::Modals-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form action="{{ route('exedir.operational-export') }}" method="POST" id="export"
                                autocomplete="off">
                                @csrf
                                <!--begin::Input group-->
