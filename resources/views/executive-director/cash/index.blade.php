...
@section('title', 'Cash Journal | Executive Director')

@section('page-title') <a href="{{ route('exedir.cash-index') }}" class="text-dark text-hover-primary">Cash Journal</a>
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container" id="kt_content_container">
            <!--begin::Card-->
            @livewire('executive-director.filter-index-cash')
            <!--end::Card-->
            <!--begin::Modals-->
