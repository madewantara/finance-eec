...
@section('title', 'Report | Finance Division')

@section('page-title') <a href="{{ route('findiv.report-index') }}" class="text-dark text-hover-primary">Report</a>
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <!--end::Card-->
            <!--begin::Report-->
            @livewire('finance-division.filter-index-report')
            <!--end::Report-->
        </div>
        <!--end::Container-->
    </div>
