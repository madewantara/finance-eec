...
@section('page-title') <a href="{{ route('findiv.dashboard') }}" class="text-dark">
...
@section('content')
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form" id="formSign" action="{{ route('findiv.signature-create') }}" novalidate
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_content_container" class="container">
                                                ...
                                                <div class="row align-items-center mt-n2 mt-lg-n1">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                            <a href="{{ route('findiv.project-detail', ['uuid' => $ap->uuid]) }}"
            ...
            <!--end::Row-->
            @livewire('finance-division.edit-transaction-dashboard')
        </div>
        <!--end::Container-->
    </div>
    <!--end::Content-->
