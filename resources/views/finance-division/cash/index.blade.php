                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form action="{{ route('findiv.cash-export') }}" method="POST">
                                            @csrf
                                            <!--begin::Input group-->
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <input class="form-control form-control-solid"
                                                    placeholder="Pick a date range" id="datefilterex" name="datefilterex"
                                                    type="text">
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class="form-control form-select account-multipleex"
                                                    data-pharaonic="select2" id="accountsex" name="accountsex[]"
                                                    multiple="multiple">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <select class="form-control form-select project-multipleex"
                                                    data-pharaonic="select2" id="projectsex" name="projectsex[]"
                                                    multiple="multiple">
