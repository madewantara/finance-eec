...
@section('title', 'Detail Mandiri Operational Transaction | Finance Division')
                            ...
                            <div class="mx-auto w-100">
                                ...
                                <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                                    ...
                                    <div class="text-sm-end">
                                        <!--begin::Logo-->
                                        <a href="{{ asset('assets/image/logo/main-logo.png') }}"
                                ...
                                <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                                    ...
                                    <div class="my-1 me-5">
                                        <!-- begin::Print-->
                                        <form method="post"
                                            action="{{ route('findiv.operational-detail-export', ['uuid' => $transaction[0]->uuid]) }}">
                                            @csrf
                                    ...
                                    <a href="{{ route('findiv.operational-create') }}"
                                        class="btn btn-primary my-1">Create
                                        Transaction</a>
                                    <!-- end::Action-->
                                </div>
                                <!-- end::Footer-->
