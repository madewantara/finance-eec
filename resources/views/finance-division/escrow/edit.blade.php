...
@section('title', 'Edit Mandiri Escrow Transaction | Finance Division')

@section('page-title') <a href="{{ route('findiv.escrow-index') }}" class="text-dark text-hover-primary">Mandiri
        Escrow</a>
@endsection

@section('sub-page-title', 'Edit Mandiri Escrow Transaction')
                ...
                <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            @livewire('finance-division.edit-escrow', ['uuid' => $uuid])
                        </div>
                        <!--end::Card body-->
                    </div>
                    <!--end::Card-->
