        ...
        init: function () {
            ...
            initChart(
                ...
                [
                    ...
                    18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17, 19, 17,
                ],
                false
            );
            initChart(
                ...
                [
                    17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21,
                    18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17, 18, 18,
                ],
                true
            );
        },
...
var KTChartsWidget20 = (function () {
    ...
    var initChart = function () {
        ...
        if (
            parseInt(profitValue[4]) > parseInt(profitValue[3]) ||
            parseInt(profitValue[4]) == parseInt(profitValue[3])
        ) {
            var baseColor = KTUtil.getCssVariableValue("--bs-success");
            var lightColor = KTUtil.getCssVariableValue("--bs-success");
        } else if (parseInt(profitValue[4]) < parseInt(profitValue[3])) {
        ...
        var options = {
            ...
            yaxis: {
                max: Math.max.apply(null, profitValue),
                min: Math.min.apply(null, profitValue),
                tickAmount: 4,
                labels: {
                    style: {
                        colors: labelColor,
            ...
            series2.bullets.push(function () {
                return am5.Bullet.new(root, {
                    sprite: am5.Circle.new(root, {
                        ...
                        radius: 5,
                        fill: am5.color(
                            KTUtil.getCssVariableValue("--bs-light-success")
                        ),
                    }),
                });
            });
